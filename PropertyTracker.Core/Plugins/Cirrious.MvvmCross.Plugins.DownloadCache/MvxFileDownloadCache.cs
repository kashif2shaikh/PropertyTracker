...
namespace Cirrious.MvvmCross.Plugins.DownloadCache
{
        ...
        , IMvxFileDownloadCache
    {
		...
		public void PurgeFile(string httpSource)
		{
			RunSyncWithLock (() => {
				Entry entryToDelete;
				if (_entriesByHttpUrl.TryGetValue (httpSource, out entryToDelete)) {
					_entriesByHttpUrl.Remove (entryToDelete.HttpSource);
					_toDeleteFiles.Add (entryToDelete.DownloadedPath);
				}											
			});		
		}
