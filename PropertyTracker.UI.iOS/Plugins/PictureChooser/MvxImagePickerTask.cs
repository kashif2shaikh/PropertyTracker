...
//
// Kashif: Modified so we can take selfies!
...
namespace PropertyTracker.UI.iOS.Plugins.PictureChooser
{
          ...
          , IMvxPictureChooserTask
    {
                                ...
                                Action assumeCancelled)
        {
			...
			_picker.CameraDevice = UIImagePickerControllerCameraDevice.Front; // kashif: take selfies only
            ChoosePictureCommon(maxPixelDimension, percentQuality, pictureAvailable, assumeCancelled);
        }
